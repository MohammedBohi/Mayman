...
const getDisponibiliteMois = async (req, res) => {
  ...
  try {
    ...
    // Grouper réservations par date (avec mode/departement/personnes pour la règle de clustering)
    const resaMap = {};
    const resaFullMap = {};
